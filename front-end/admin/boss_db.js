...
var db = new Array (
  ...
  "APPTEST_ATL",     "boss35@APPTEST_ATL"
);
...
var cfg = new Array (
    "Рабочая версия(bk_prod,APP,APPTEST,boss35@APPTEST_ATL)",   // name -  что отображается
    "bk_prod",                             // value - что подставится
    "boss35@APP,boss35@APPTEST,boss35@APPTEST_ATL", // список, через запятую, доступных БД
    "Для тестирования (bk_test,APPTEST,boss35@APPTEST_ATL)",
    "bk_test",
    "boss35@APPTEST,boss35@APPTEST_ATL"
);
...
var srv = new Array (
    ...
    "bk_prod, bk_test",                           // список, через запятую, доступных реализаций
    "OASBOSS2",                                   
    "oasboss2:7778;rep_oasboss2_FRHome1;C:\\TEMP",
    "bk_prod, bk_test"       
// ,"BK_APPSRV тестовый",
//    "http://BK_APPSRV_TEST:7778;rep_BK_APPSRV_TEST_FRHome1;C:\\BK\\TEMP",
//    "bk_test"
// ,"localhost",
